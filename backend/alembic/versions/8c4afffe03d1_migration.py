...
down_revision: str | None = "8042be50cde3"
...
def upgrade() -> None:
    ...
    op.add_column(
        "clear_cuts", sa.Column("bdf_mixed_area_hectare", sa.Float(), nullable=True)
    )
    op.add_column(
        "clear_cuts", sa.Column("bdf_poplar_area_hectare", sa.Float(), nullable=True)
    )
    op.add_column(
        "clear_cuts",
        sa.Column("ecological_zoning_area_hectare", sa.Float(), nullable=True),
    )

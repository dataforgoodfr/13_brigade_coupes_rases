...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "relevant_for_alert_cnpf_ddt_psg_thresholds", sa.Boolean(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_clear_cut_report_forms_id"),
        "clear_cut_report_forms",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_clear_cut_report_forms_id"), table_name="clear_cut_report_forms"
    )
    op.drop_index(
        op.f("ix_clear_cut_report_forms_forest_description"),

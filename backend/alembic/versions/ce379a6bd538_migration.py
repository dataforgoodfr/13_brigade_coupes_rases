...
Revision ID: ce379a6bd538
Revises: 
Create Date: 2025-04-01 19:25:52.844772
...
def upgrade() -> None:
    ...
    op.create_table('ecological_zonings',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_ecological_zonings_id'), 'ecological_zonings', ['id'], unique=False)
    ...
    op.create_table('clear_cuts_reports',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_clear_cuts_reports_id'), 'clear_cuts_reports', ['id'], unique=False)
    op.create_index(op.f('ix_clear_cuts_reports_slope_area_ratio_percentage'), 'clear_cuts_reports', ['slope_area_ratio_percentage'], unique=False)
    ...
    sa.Column('boundary', geoalchemy2.types.Geometry(geometry_type='MULTIPOLYGON', srid=4326, from_text='ST_GeomFromEWKT', name='geometry', nullable=False), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_table('clear_cut_ecological_zoning',
    sa.Column('clear_cut_id', sa.Integer(), nullable=False),
    sa.Column('ecological_zoning_id', sa.Integer(), nullable=False),
    sa.Column('area_hectare', sa.Float(), nullable=False),
    sa.ForeignKeyConstraint(['clear_cut_id'], ['clear_cuts.id'], ),
    sa.ForeignKeyConstraint(['ecological_zoning_id'], ['ecological_zonings.id'], ),
    sa.PrimaryKeyConstraint('clear_cut_id', 'ecological_zoning_id')
    )
    op.create_table('registry_clear_cut',
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_clear_cuts_reports_slope_area_ratio_percentage'), table_name='clear_cuts_reports')

...
def upgrade() -> None:
    ...
    op.create_table('rules_ecological_zonings',
    ...
    op.add_column('clear_cuts', sa.Column('ecological_zoning_area_ha', sa.Float(), nullable=True))
...
def downgrade() -> None:
    ...
    op.add_column('clear_cut_ecological_zoning', sa.Column('area_hectare', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False))

...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_ecological_zonings_code'), 'ecological_zonings', ['code'], unique=False)
    op.create_index(op.f('ix_ecological_zonings_id'), 'ecological_zonings', ['id'], unique=False)
    op.create_index(op.f('ix_ecological_zonings_name'), 'ecological_zonings', ['name'], unique=False)
    op.create_index(op.f('ix_ecological_zonings_sub_type'), 'ecological_zonings', ['sub_type'], unique=False)
    op.create_index(op.f('ix_ecological_zonings_type'), 'ecological_zonings', ['type'], unique=False)
    ...
    op.create_index(op.f('ix_clear_cuts_area_hectare'), 'clear_cuts', ['area_hectare'], unique=False)
    ...
    op.create_table('ecological_zoning_clear_cut',
    ...
    op.create_index(op.f('ix_registries_district_code'), 'registries', ['district_code'], unique=False)

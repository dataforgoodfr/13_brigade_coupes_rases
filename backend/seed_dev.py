    ...
    try:
        ...
        all_departments = [
            ...
            Department(
                ...
                cities=[City(name="Marseille", zip_code="13000")],
            ),
            ...
            Department(
                code="75", name="Paris", cities=[City(name="Paris", zip_code="75000")]
            ),
        ...
        bouches_du_rhone = db.query(Department).filter_by(code="13").first()
        ...
        clear_cuts = [
            ...
            ClearCut(
                ...
                status="to_validate",
                city=bouches_du_rhone.cities[
                    0
                ],  # Assurez-vous que 'marseille' est défini dans votre code
                user=volunteer,
            ),
            ClearCut(
                ...
                status="validated",
                city=bouches_du_rhone.cities[0],
                user=admin,
            ),
            ClearCut(
                cut_date=datetime.now() - timedelta(days=10),

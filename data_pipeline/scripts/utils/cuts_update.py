...
class cutsUpdateRules:
    ...
    def update_clusters(self, clear_cut_pairs):
        ...
        updated_data.loc[:, "date_max"] = updated_data.groupby("index_left")["date_max_right"].transform("max")
    ...
    def find_new_clusters(self, gdf_new, clear_cut_pairs):
        ...
        self.logger.info(f"Number of unique elements in gdf_new matched: {matched_unique_count}")
